...
if __FILE__ == $0
  puts "Running pedometer test..."
  
  raw_data = [
    "0.2,0.1,9.8|0.1,0.1,9.8;",
    "2.5,1.8,12.0|0.1,0.1,9.8;",
    "0.1,0.1,8.0|0.1,0.1,9.8;",
    "0.2,0.2,9.8|0.1,0.1,9.8;",
    "2.6,1.9,12.2|0.1,0.1,9.8;",
    "0.1,0.1,8.0|0.1,0.1,9.8;",
    "0.2,0.1,9.8|0.1,0.1,9.8;",
    "2.4,1.7,12.0|0.1,0.1,9.8;",
    "0.1,0.1,8.0|0.1,0.1,9.8;",
    "0.2,0.2,9.8|0.1,0.1,9.8;",
    "2.5,1.8,12.1|0.1,0.1,9.8;",
    "0.1,0.1,8.0|0.1,0.1,9.8;",
    "0.2,0.1,9.8|0.1,0.1,9.8;",
    "2.6,1.9,12.2|0.1,0.1,9.8;",
    "0.1,0.1,8.0|0.1,0.1,9.8;",
  ...
  user = User.new('male', 175)
  trial = 1

  pipeline = Pipeline.run(raw_data, user, trial)

  puts "\nFinal Results:"
  puts "Steps detected: #{pipeline.analyzer.steps}"
  puts "Distance traveled: #{pipeline.analyzer.distance.round(2)} cm"
end
